...
namespace UnityEditor
{
    internal class ReroStandardShaderGUI : ShaderGUI
    {
        ...
        {
			rstyle= new GUIStyle(GUI.skin.label);
        ...
        void DoAlbedoArea(Material material)
        {
			...
			shadowToggle.floatValue = EditorGUILayout.Toggle("Tint Shadows?", shadowToggle.floatValue==1, GUILayout.MaxWidth(EditorGUIUtility.labelWidth+13.0f))?1:0;
            GUILayout.Space(-17);
			
            GUILayout.BeginHorizontal();
			EditorGUI.BeginDisabledGroup(shadowToggle.floatValue == 0);
			GUILayout.Space(20);
			m_MaterialEditor.ShaderProperty(shadowColor, " ");
			...
			if(rampHard.floatValue == 1 && rampOff.floatValue == 0)
			{
				GUILayout.Space(-5);
				EditorGUILayout.LabelField("-Standard-", rstyle);
				GUILayout.Space(-5);
			}
